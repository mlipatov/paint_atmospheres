...
parser = argparse.ArgumentParser(description="Example: \n" +\
	"python setup_star.py \'star.pkl\' \'limbdark.pkl\' \'ellip.pkl\' 1000 " +\
...
parser.add_argument("pkl_efile", help="name of the .pkl elliptic integration file to access")
...
pkl_efile = args.pkl.efile # elliptic integration file
## star parameters 
...
## unpickle the integration setup
with open(pkl_efile, 'rb') as f:
	el = pickle.load(f)
z_step = el.z_step
